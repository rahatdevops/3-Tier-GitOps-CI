  ...
  return (
    <div className="app-layout">
      <header className="app-header slide-down">
        <div className="brand">
          <img src={logo} alt="rahatdevops logo" className="logo" />
          <div>
            <h1 className="brand-title">rahatdevops</h1>
            <p className="nav-subtitle">User Management</p>
          </div>
        </div>
      </header>
      <AnimatedBanner message="Welcome to rahatdevops 🚀" />
      ...
      <footer className="app-footer">
        <p>&copy; {new Date().getFullYear()} rahatdevops. All rights reserved.</p>
      </footer>
